...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Gestão de Cursos</h1>
            <p class="mt-1 text-sm text-gray-500">Gerir cursos do sistema</p>
        </div>
        <a 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-500">
                                @if($curso->disciplinas->count() > 0)
                                    {{ $curso->disciplinas->count() }} disciplina(s)
                                @else
                                    <span class="text-gray-400">Sem disciplinas</span>
                                @endif
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                ...
                                <form 
                                    ...
                                    class="inline"
                                    onsubmit="return confirm('Tens a certeza que queres eliminar este curso?');"
                                >
                                    @csrf
                                    @method('DELETE')
                                    <button 
                    ...
                    <tr>
                        <td colspan="3" class="px-6 py-12 text-center">
                            ...
                            <h3 class="mt-4 text-sm font-medium text-gray-900">Nenhum curso encontrado</h3>
                            <p class="mt-2 text-sm text-gray-500">Ainda não foram criados cursos.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
