...
<div class="space-y-8">
    ...
    <div>
        ...
        <h1 class="text-2xl font-semibold text-gray-800 mt-2">Criar Novo Curso</h1>
        <p class="mt-1 text-sm text-gray-500">Preenche os dados abaixo para criar um novo curso</p>
    </div>
