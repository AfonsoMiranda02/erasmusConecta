...
<div class="space-y-8">
    ...
    <div>
        ...
        <h1 class="text-2xl font-semibold text-gray-800 mt-2">Editar Utilizador</h1>
        <p class="mt-1 text-sm text-gray-500">Atualiza os dados do utilizador</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="space-y-6">
            ...
            <div>
                ...
                <input 
                    ...
                    type="text" 
                    required 
                    value="{{ old('num_processo', $user->num_processo) }}"
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                    Nova Palavra-passe (deixa em branco para manter a atual)
                </label>
                <input 
                    id="password" 
                    name="password" 
                ...
                <div>
                    <label class="flex items-center">
                        <input 
                            ...
                            name="is_aprovado" 
                            value="1"
                            {{ old('is_aprovado', $user->is_aprovado) ? 'checked' : '' }}
                            class="h-4 w-4 text-teal-600 focus:ring-teal-500 border-gray-300 rounded"
                        >
