...
<div class="space-y-8">
    ...
    <div>
        ...
        <h1 class="text-2xl font-semibold text-gray-800 mt-2">Criar Nova Disciplina</h1>
        <p class="mt-1 text-sm text-gray-500">Preenche os dados abaixo para criar uma nova disciplina</p>
    </div>

    <!-- Formulário -->
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        <form method="POST" action="{{ route('admin.disciplinas.store') }}" class="space-y-6">
            @csrf
