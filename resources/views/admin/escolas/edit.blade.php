...
<div class="space-y-8">
    ...
    <div>
        ...
        <h1 class="text-2xl font-semibold text-gray-800 mt-2">Editar Escola</h1>
        <p class="mt-1 text-sm text-gray-500">Atualiza os dados da escola</p>
    </div>

    <!-- Formulário -->
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        <form method="POST" action="{{ route('admin.escolas.update', $escola->id) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input 
                    ...
                    type="text" 
                    required 
                    value="{{ old('instituicao', $escola->instituicao) }}"
            ...
            <div>
                ...
                <input 
                    ...
                    type="text" 
                    required 
                    value="{{ old('morada', $escola->morada) }}"
            ...
            <div>
                ...
                <input 
                    ...
                    type="text" 
                    required 
                    value="{{ old('codigo_postal', $escola->codigo_postal) }}"
            ...
            <div>
                ...
                <input 
                    ...
                    type="text" 
                    required 
                    value="{{ old('abreviacao', $escola->abreviacao) }}"
