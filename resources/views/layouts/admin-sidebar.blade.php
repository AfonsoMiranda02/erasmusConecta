    ...
    <div class="flex flex-col h-screen">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            ...
            <a 
                ...
                class="flex items-center px-3 py-2.5 rounded-md transition-colors {{ \Illuminate\Support\Str::startsWith($currentRoute, 'admin.documentos') ? 'bg-blue-50 text-teal-700 border-l-2 border-teal-600' : 'text-gray-700 hover:bg-gray-100 hover:text-teal-700' }}"
            >
                <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
